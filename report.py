...
class Report:
    def __init__(self,root):
        ...
        self.root.geometry("960x500+200+100")
        ...
        email2=Label(self.root,text="- Developer Name: Purab Jana, Email-\'Purab\'s email\'", font=("times new roman",15,"bold"), bg= "lightcyan1", fg="green")
        email2.place(x=20,y=200)

        email3=Label(self.root,text="- Developer Name: Samriddha Karmakar, Email-\'Samriddha\'s email\'", font=("times new roman",15,"bold"), bg= "lightcyan1", fg="green")
